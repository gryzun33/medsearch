...
const SearchMedItem = ({ medicine }: Props) => {
  return (
    <li className="flex flex-wrap w-full p-2 md:pl-0 text-gray-700 items-center border-t-[1px] border-gray-200 hover:bg-green-50 transition-colors">
      <div className="order-1 flex flex-col w-[65%] md:w-9/12 md:order-2 md:flex-row">
        <div className="text-sm md:w-[55.5%] lg:text-base">{medicine.name}</div>
